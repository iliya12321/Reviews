![yamdb_final event parameter](https://github.com/iliya12321/yamdb-final/actions/workflows/yamdb_workflow.yml/badge.svg?event=push)
...
Проект доступен по адресу: http://158.160.43.45/api/v1/

### Настроен CI/CD

Запуск Flake8 и тестов, обновление образа DockerHub, деплой на сервер.

### Полная документация API: http://158.160.43.45/redoc/
